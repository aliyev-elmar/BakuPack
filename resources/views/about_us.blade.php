    ...
    <section id="breadcrumb" class="main-section">
        <div class="container">
            <ul>
                ...
                <li><i class="fas fa-slash"></i> Haqqimizda</li>
            </ul>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7">
                    <p class="about-title">Xammal</p>
                    <p class="about-subtitle">Dünyanın ən qabaqcıl istehsalçılarından (Çin, Rusiya, Türkiyə və s.) birbaşa xammal idxal edirik. Xammalın birbaşa sifarişi rəqabətdə üstünlüyümüzü təmin edir.</p>
                </div>
                ...
                <div class="col-12 col-lg-7">
                    ...
                    <p class="about-title">PEŞƏKAR DİZAYN İŞLƏRİ</p>
                    <p class="about-subtitle">Müştərilərilərimizin istəyinə və zövqünə uyğun dizaynları hazırlamaqla birlikdə öz təkliflərimizi də təqdim edirik</p>
                </div>
                <div class="col-12 col-lg-7">
                    <p class="about-title">Çatdırılma</p>
                    <p class="about-subtitle">Qayğıkeş və diqqətli kadrlarımızla məhsulunuzun yerinə çatdırılmasını öz üzərimizə götürürük. İxtisaslaşmış kadrlar müştəri məmnuniyyətini hər zaman ön planda saxlayır.</p>
                </div>
                <div class="col-12 col-lg-5">
